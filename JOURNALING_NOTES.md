...
_Last updated: **Austria finalize — real photo album wired in.** Family streamed their full Austria album (~30 photos, recovered via transcript-base64 method → `images/austria/`). DONE & pushed on branch `claude/austria-magazine-finalize-7mu00v`: gave Salzburg / First Night (Burg Altpernstein) / Hallstatt their real uncropped photo heroes (replaced TBD placeholders); **rebuilt the imagined "Tastes of Austria" food page** (fake Figlmüller/Sacher cards, which were also CLIPPING) into a real schnitzel-lunch feature (castle breakfast + Salzburg ice-cream + First-Night pizza in prose); added two new photo spreads — **"At the garden gate"** (Salzburg: Lana + kids at the Mirabell steps pointing to the fortress) and **"The most photographed village"** (Hallstatt family at the lakeside railing). Fixed back-cover Prague teaser ("before the crowds", not "at dawn"). All 23 pages screenshot-verified non-clipping. **STILL NEEDS USER TEXT (can't invent):** (1) the "Habsburg Forever" Vienna intro page (folio 05, eyebrow IMPERIAL VIENNA·DAY 07) is still imagined — Hofburg-morning/Gloriette/Orangery-Mozart-concert fiction + TBD hero (no real Schönbrunn *exterior* photo exists yet, only interiors); (2) the Reflections page still has FALSE lines (60m salt-mine slide + Hallstatt funicular — both never happened, mine was closed). HELD unplaced Austria photos ready for more spreads: Salzburg Residenzbrunnen/Getreidegasse/Residenz-facade/Do-Re-Mi-avenue/horse-fountain/family-cathedral(tilted); Hallstatt boat/market-square/postcard-vs-real/street/viewpoint; castle exterior-selfie/breakfast/valley-view; autobahn._
